...
![mariano-morales-blog-tecnologia-1](/content/images/2018/04/mariano-morales-blog-tecnologia-1.png)
...
You will be back to the prompt `user@host $:`
...
Before visiting our website, let's make some tiny changes:

12.  Open index.md (md stands for "markdown", a pseudo-language which is more like a typesetting system for writing enhancement through shortcuts)
...
Without closing the terminal, open a browser and go to `localhost:4000`
...
15. Save the file onto the Desktop or any place that you can easily access.  
...
Visit `localhost:4000/resume/`

<center>
<iframe width="560" height="350" src="https://www.youtube.com/embed/tooIl1msOcU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</center>
<br>



## Up next (week 11, part 2):
